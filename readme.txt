...
Ejecuta la aplicación:streamlit run audio-enhancer.py
...
Crea una nueva app, selecciona el repositorio y el archivo audio-enhancer.py.
...
git branch -M main
git remote add origin https://github.com/<tu-usuario>/voice-enhancement.git
git push -u origin main


Verifica que los archivos audio-enhancer.py, requirements.txt y README.md estén en el repositorio.
